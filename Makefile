...
CFLAGS				 := -I${inc_dir} -I${libft_dir}/include -Wall -Werror -Wextra -std=c11 -O3
# CFLAGS options:
...
clean:
	@echo "\n[$(GRNGRN) PUSH_SWAP $(RST)]: $(RED)Objects and Executable were removed!$(RST)"
	@rm -rf ${build_dir}
